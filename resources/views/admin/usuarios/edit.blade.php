...
@section('content')
    <div class="mx-auto max-w-3xl">
        <header>
            ...
            <h1 class="mt-2 text-3xl font-bold tracking-tight">Editar usuario</h1>
        </header>

        <form method="POST" action="{{ route('admin.users.update', $usuarioEditar) }}" class="mt-8">
            @csrf
            @method('PUT')
            @include('admin.partials.form-usuario', ['usuarioForm' => $usuarioEditar])
